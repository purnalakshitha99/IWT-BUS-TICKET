        ...
        <div class="row text-center">
          ...
          <div class="col">
            <button
              ...
              aria-selected="false"
            >
              <ion-icon name="person-add-outline" class="tabIcon"></ion-icon>
              <small class="tabText">Add Employee</small>
            </button>
          </div>
          <div class="col">
            <button
              ...
              aria-selected="false"
            >
              <ion-icon name="bus-outline" class="tabIcon"></ion-icon>
              <small class="tabText">Add Bus</small>
            </button>
          </div>
          <div class="col">
            <button
              ...
              aria-selected="false"
            >
              <ion-icon name="document-outline" class="tabIcon"></ion-icon>
              <small class="tabText">View Trip Deatails</small>
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="tabsRenderArea mt-2">
      <div class="tab-content" id="nav-tabContent">
        ...
        <div
          ...
          style="height: 100vh"
        >
          <iframe id="frame" style="width: 100%; height: 100%;" src="employee registration.html"></iframe>
        </div>
        <div
          ...
          style="height: 100vh"
        >
          <iframe id="frame" style="width: 100%; height: 100%;" src="addBusManagerInterface.html"></iframe>
        </div>
        <div
          class="tab-pane fade mt-1"
          id="list-profile"
        ...
        >
          <iframe id="frame" style="width: 100%; height: 100%;" src="Trip Report.html"></iframe>
        </div>
      </div>
    </div>
