        ...
        <form class="row g-3p-3">
            ...
            <div class="col-md-4">
                ...
                <select id="inputState" class="form-select">
                    <option selected>Luxuary</option>
                    <option>Semi - Luxuary</option>

                </select>
            </div>
            <div class="col-md-6">
                <label for="validationCustom01" class="form-label">Bus Registration No</label>
                <input type="text" class="form-control" id="validationCustom01" required>
              
            </div>
            <div class="col-md-6">
                <label for="validationCustom02" class="form-label">Regitered Owner</label>
            ...
            <div class="col-12">
                <label for="inputAddress" class="form-label">Owner's Address</label>
                ...
                <div class="col">
                    <div class="input-group mb-3">
                        <span class="input-group-text mt-3" id="basic-addon1">Added Date</span>
