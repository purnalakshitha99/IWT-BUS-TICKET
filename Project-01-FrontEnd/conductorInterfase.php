        ...
        <div class="row text-center">
          ...
          <div class="col">
            ...
            >
              ...
              <small class="tabText">Ticket Generator</small>
            </button>
          </div>
          <div class="col">
            <button
              ...
              aria-selected="false"
            >
              <ion-icon name="chevron-up-circle-outline" class="tabIcon"></ion-icon>
              <small class="tabText">Situation Update</small>
            </button>
          </div>
          <div class="col">
            <button
              ...
              aria-selected="false"
            >
              <ion-icon name="scan-circle-outline" class="tabIcon"></ion-icon>
              <small class="tabText">Scan</small>
            </button>
          </div>          
        </div>
      </div>
    ...
    <div class="tabsRenderArea mt-2">
      <div class="tab-content" id="nav-tabContent">
        <div
          ...
          style="height: 100vh"
        >
        <iframe id="frame" style="width: 100%; height: 100%;" src="conductorDashboard.html"></iframe>
        </div>
        <div
          ...
          style="height: 100vh"
        >
          <iframe id="frame" style="width: 100%; height: 100%;" src="conductoTicketGeneration.html"></iframe>
        </div>
        <div
          ...
          style="height: 100vh"
        >
          <iframe id="frame" style="width: 100%; height: 100%;" src="Situation_Update.html"></iframe>
        </div>
        <div
          class="tab-pane fade mt-1"
          id="list-profile"
