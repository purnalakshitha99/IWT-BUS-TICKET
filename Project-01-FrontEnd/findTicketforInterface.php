          ...
          >
            <div class="position-sticky">
              <div class="list-group list-group-flush mx-3 mt-4">
                ...
                <a
                  class="list-group-item list-group-item-action active sidebarnew1"
                  ...
                  aria-selected="false"
                  tabindex="-1"
                  ><span>Badulla to Colombo</span></a
                >
                <!--Route No 2 Passara to Colombo(PTC)-->
                <a
                  class="list-group-item list-group-item-action sidebarnew1"
                  id="list-proposal-list"
                  data-bs-toggle="list"
                  href="#list-proposal"
                  role="tab"
                  aria-controls="list-proposal"
                  aria-selected="false"
                  ><span>Passara to Colombo</span></a
                >
                ...
                <a
                  ...
                  href="#list-employee"
                  role="tab"
                  aria-controls="list-employee"
                  aria-selected="false"
                  ><span>Ella to Colombo</span></a
                >
                ...
                <a
                  ...
                  href="#list-reports"
                  role="tab"
                  aria-controls="list-reports"
                  aria-selected="false"
                  ><span>Bandarawela to Colombo</span></a
                >
                <!--Route No 5 Badulla to Kandy to Colombo (BTKTC)-->
                <a
                  class="list-group-item list-group-item-action sidebarnew1"
                  id="list-communication-list"
                  data-bs-toggle="list"
                  href="#list-communication"
                  role="tab"
                  aria-controls="list-communication"
                  aria-selected="false"
                  ><span>Badulla-Kandy to Colombo</span></a
                >
          ...
          <div id="content">
            <div class="tab-content" id="nav-tabContent">
              ...
              <div
                ...
                id="list-proposal"
                role="tabpanel"
                aria-labelledby="list-proposal-list"
                style="height: 100vh"
              >
                <!--Route no1 start-->
                <div class="container my-0">
              ...
              <div
                class="tab-pane fade"
                id="list-communication"
                role="tabpanel"
                aria-labelledby="list-communication-list"
                style="height: 100vh"
              >
                <!--Route no2 start-->
                <div class="container my-0">
            ...
            <div class="row">
              <div class="col">
                <div class="input-group mb-3">
                  <span class="input-group-text mt-3" id="basic-addon1"
                    >Diparture Date</span
                  >
                  <input
                    type="date"
                        ...
                        <button class="seatWithNumberButton">
                          <div class="text-center seatWithNumber">
                            <span>
                              ...
                              <img
                                src="https://thenounproject.com/api/private/icons/661611/edit/?backgroundShape=SQUARE&backgroundShapeColor=%23000000&backgroundShapeOpacity=0&exportSize=752&flipX=false&flipY=false&foregroundColor=%23000000&foregroundOpacity=1&imageFormat=png&rotation=0"
                                class="rounded seatImage"
                                alt="..."
                              />
                            </span>
                          </div>
